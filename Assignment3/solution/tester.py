...
def getOpenConnection(user='postgres', password='arunvetri', dbname='ddsassignment3'):
...
if __name__ == '__main__':
	...
	Assignment3.ParallelJoin( 'movies', 'ratings', 'MovieId1', 'MovieId', 'parallelJoinOutputTable', con);
	a = raw_input("Check in database and once you are done, press enter to delete all tables: ");
	deleteTables('ALL', con);
